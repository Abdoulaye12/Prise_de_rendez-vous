...
<header class="header_section">
            <div class="container">
               <nav class="navbar navbar-expand-lg custom_nav-container ">
                  ...
                  <div>
                  <a href="" type="submit" class="lien">AdminConnexion</a>
                  </div>
               </nav>
        </div>
</header>
    ...
    <div class="row">
        <div class="col-xl-7">
            <div class="card mb-4">
                ...
                <div class="mb-3">
                    <label>Nom</label>
                    <input name="nom" class="form-control" type="text" placeholder="Ndiaye">
                    </div>
                    <div class="mb-3">
                        <label>Prenom</label>
                        <input name="prenom" class="form-control" type="text" placeholder="Moustapha">
                    </div>
                    <div class="mb-3">
                        <label>Email</label>
                        <input name="email" class="form-control" type="text" placeholder="ndiayemoustapha@gmail.com">
                    </div>
                    <div class="mb-3">
                        <label>Adresse</label>
                        <input type="text" class="form-control" name="adresse" placeholder="122, cité SHS, Guédiawaye">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="col-md-7 edit">
                        <button class="btn btn-outline-secondary" type="submit" name="edit">Vallider</button>
                        <button class="btn btn-outline-danger" type="reset" name="annuler">Annuler</button>
                    </div>   
                    </form>
                </div>
            </div>
